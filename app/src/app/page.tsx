  ...
  return (
    <>
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 py-8 md:px-6">
        <div className="rounded-lg border-2 border-dashed border-neutral-300 bg-background/50 p-6 backdrop-blur-sm md:p-10 dark:border-neutral-700">
          <main id="main-content" className="mx-auto max-w-2xl">
            ...
            {/* Bio paragraph */}
            <p className="animate-fade-in-delay-1 mt-8 font-mono text-sm leading-relaxed text-neutral-600 dark:text-neutral-400">
